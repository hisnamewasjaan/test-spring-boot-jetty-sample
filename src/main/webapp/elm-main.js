...
var _user$project$MainButton$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'Increment':
...
var _user$project$MainButton$model = 0;
var _user$project$MainButton$Half = {ctor: 'Half'};
var _user$project$MainButton$Double = {ctor: 'Double'};
var _user$project$MainButton$Decrement = {ctor: 'Decrement'};
var _user$project$MainButton$Increment = {ctor: 'Increment'};
var _user$project$MainButton$view = function (model) {
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onClick(_user$project$MainButton$Decrement),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onClick(_user$project$MainButton$Half),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
				...
				_1: {
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onClick(_user$project$MainButton$Increment),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onClick(_user$project$MainButton$Double),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('x2'),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}
...
var _user$project$MainButton$main = _elm_lang$html$Html$beginnerProgram(
	{model: _user$project$MainButton$model, view: _user$project$MainButton$view, update: _user$project$MainButton$update})();

var _user$project$MainWebsockets$viewMessage = function (msg) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
...
var _user$project$MainWebsockets$echoServer = 'ws://echo.websocket.org';
var _user$project$MainWebsockets$Model = F2(
	function (a, b) {
		return {input: a, messages: b};
	});
var _user$project$MainWebsockets$init = {
	ctor: '_Tuple2',
	_0: A2(
		_user$project$MainWebsockets$Model,
		'',
		{ctor: '[]'}),
	_1: _elm_lang$core$Platform_Cmd$none
};
var _user$project$MainWebsockets$update = F2(
	function (msg, _p0) {
		var _p1 = _p0;
		...
		switch (_p2.ctor) {
			case 'Input':
				return {
					ctor: '_Tuple2',
					_0: A2(_user$project$MainWebsockets$Model, _p2._0, _p4),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'Send':
				return {
					ctor: '_Tuple2',
					_0: A2(_user$project$MainWebsockets$Model, '', _p4),
					_1: A2(_elm_lang$websocket$WebSocket$send, _user$project$MainWebsockets$echoServer, _p3)
				};
			default:
				return {
					ctor: '_Tuple2',
...
var _user$project$MainWebsockets$NewMessage = function (a) {
	return {ctor: 'NewMessage', _0: a};
};
var _user$project$MainWebsockets$subscriptions = function (model) {
	return A2(_elm_lang$websocket$WebSocket$listen, _user$project$MainWebsockets$echoServer, _user$project$MainWebsockets$NewMessage);
};
var _user$project$MainWebsockets$Send = {ctor: 'Send'};
var _user$project$MainWebsockets$Input = function (a) {
	return {ctor: 'Input', _0: a};
};
var _user$project$MainWebsockets$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onInput(_user$project$MainWebsockets$Input),
					_1: {ctor: '[]'}
				},
				{ctor: '[]'}),
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onClick(_user$project$MainWebsockets$Send),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
				...
				_1: {
					...
					_0: A2(
						...
						A2(
							_elm_lang$core$List$map,
							_user$project$MainWebsockets$viewMessage,
...
var _user$project$MainWebsockets$main = _elm_lang$html$Html$program(
	{init: _user$project$MainWebsockets$init, view: _user$project$MainWebsockets$view, update: _user$project$MainWebsockets$update, subscriptions: _user$project$MainWebsockets$subscriptions})();

var Elm = {};
Elm['MainButton'] = Elm['MainButton'] || {};
if (typeof _user$project$MainButton$main !== 'undefined') {
    _user$project$MainButton$main(Elm['MainButton'], 'MainButton', undefined);
}
Elm['MainWebsockets'] = Elm['MainWebsockets'] || {};
if (typeof _user$project$MainWebsockets$main !== 'undefined') {
    _user$project$MainWebsockets$main(Elm['MainWebsockets'], 'MainWebsockets', undefined);
}
